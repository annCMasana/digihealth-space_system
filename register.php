            ...
            <div id="login" class="login loginpage col-lg-offset-3 col-md-offset-3 col-sm-offset-3 col-xs-offset-0 col-xs-12 col-sm-6 col-lg-6">    
                ...
                <div class="box login">
                    ...
                    <div class="content-body" style="padding-top:30px">
                        ...
                        <form id="msg_validate" method="post" action="sign-up.php" novalidate="novalidate" class="no-mb no-mt">
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <div class="col-lg-6 no-pl">
                                        <div class="form-group">
                                            <label class="password">User Type</label>
                                            <div class="controls">
                                        ...
                                        <div class="pull-left">
                                            <input type="submit" name="submit" class="btn btn-primary mt-10 btn-corner right-15" value="Submit">
